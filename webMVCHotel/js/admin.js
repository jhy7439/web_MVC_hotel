$(function(){
	...
	$("#sub_img").on("change", function(){
		...
		filesArr.forEach(function(f){
			if(f.type.match("image/png|image/gif|image/jpeg|image/bmp|image/jpg") && f.size<2097152){
				imgs.push(f);
				var reader = new FileReader();
				reader.onload = function(e){
					var imgThumb = '<div class=""'
					// var imgThumb = "<img src=\"" + e.target.result + "\" />";
					$("#sub_imgs").append(imgThumb);
				}
